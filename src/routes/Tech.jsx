  ...
  return (
    <div>
        ...
        <div className='flex flex-col sm:flex-row mt-8 max-w-[1140px]  w-full  mx-auto text-primary shadow-xl mb-8 border border-[#85bb65]'>
            ...
            {/*<iframe width="560" height="315" src="https://www.youtube.com/embed/S9tnPr4KIEA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>*/}
            </div>
        ...
        <div className='mt-8'></div><div className='max-w-[1140px] w-full mx-auto text-primary shadow-xl px-3 pt-3 mb-8 border border-[#85bb65] '>
            ...
            {/* <iframe src="https://www.feedgrabbr.com/inframe/?widgetid=cbb542372c059f7bab5ebaf58" allowtransparency="true" style="border:0;background-color: transparent;width:100%;height:500px" ></iframe> */} 
        </div>
